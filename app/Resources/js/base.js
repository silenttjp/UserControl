$( document ).ready(function() {
        ...
        $('#user_list').on("submit","#new_user", function(){
    	    ...
    	    $.post('{{path('new_user_save_routing')}}',{
    	    		user_firstname:FN,
    	    		user_lastname:LN,
    	    		user_id:id,
    	    		user_list:list
         	   	...
         	   	$('#user_list').html(data); 
          	  	$.post('{{path('get_user_count_routing')}}',{
          	  			getUser:1
                },function(data){
       ...
       $('#user_list').on("submit","#new_list", function(){
    	    ...
    	    $.post('{{path('new_list_save_routing')}}',{
    	    	list_name:FN,
    	    	list_id:id
            },function(data){
            	$('#user_list').html(data); 
          	  	$.post('{{path('get_lists_count_routing')}}',{
        	    	getUser:1
                },function(data){
