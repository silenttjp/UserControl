...
abstract class BaseLists extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'IDG\\UserControlBundle\\ListsPeer';
    ...
    public function setUser_Lists(PropelCollection $user_Lists, PropelPDO $con = null)
    {
        ...
        foreach ($user_ListsToDelete as $user_ListRemoved) {
            $user_ListRemoved->setLists(null);
        }
     ...
     * @return PropelObjectCollection|User_List[] List of User_List objects
     */
    public function getUser_ListsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = User_ListQuery::create(null, $criteria);
