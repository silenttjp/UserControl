...
use IDG\UserControlBundle\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'IDG\\UserControlBundle\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'IDG\\UserControlBundle\\map\\UserTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \IDG\UserControlBundle\map\UserTableMap());
      }
    }
