...
use IDG\UserControlBundle\Models\User_ListPeer;
use IDG\UserControlBundle\Models\User_ListQuery;

abstract class BaseUser_List extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'IDG\\UserControlBundle\\Models\\User_ListPeer';
     ...
     * @return User_List The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = User_ListPeer::ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = User_ListPeer::USER_ID;
        }
    ...
    public function setListId($v)
    {
        ...
        if ($this->list_id !== $v) {
            $this->list_id = $v;
            $this->modifiedColumns[] = User_ListPeer::LIST_ID;
        }
    ...
    public function setDateAdded($v)
    {
        ...
        if ($this->date_added !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = User_ListPeer::DATE_ADDED;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = User_ListPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating User_List object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = User_ListPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = User_ListQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                User_ListPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(User_ListPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(User_ListPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`User_ID`';
        }
        if ($this->isColumnModified(User_ListPeer::LIST_ID)) {
            $modifiedColumns[':p' . $index++]  = '`List_ID`';
        }
        if ($this->isColumnModified(User_ListPeer::DATE_ADDED)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = User_ListPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = User_ListPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['User_List'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['User_List'][$this->getPrimaryKey()] = true;
        $keys = User_ListPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(User_ListPeer::ID)) $criteria->add(User_ListPeer::ID, $this->id);
        if ($this->isColumnModified(User_ListPeer::USER_ID)) $criteria->add(User_ListPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(User_ListPeer::LIST_ID)) $criteria->add(User_ListPeer::LIST_ID, $this->list_id);
        if ($this->isColumnModified(User_ListPeer::DATE_ADDED)) $criteria->add(User_ListPeer::DATE_ADDED, $this->date_added);
    ...
    {
        $criteria = new Criteria(User_ListPeer::DATABASE_NAME);
        $criteria->add(User_ListPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of User_List (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return User_List Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return User_ListPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new User_ListPeer();
        }
    ...
    public function getLists(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLists === null && ($this->list_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLists->addUser_Lists($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(User_ListPeer::DEFAULT_STRING_FORMAT);
    }
