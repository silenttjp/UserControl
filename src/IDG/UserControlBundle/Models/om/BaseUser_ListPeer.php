...
use IDG\UserControlBundle\Models\map\User_ListTableMap;
...
abstract class BaseUser_ListPeer
{
    ...
    const OM_CLASS = 'IDG\\UserControlBundle\\Models\\User_List';

    /** the related TableMap class for this table */
    const TM_CLASS = 'IDG\\UserControlBundle\\Models\\map\\User_ListTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUser_ListPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \IDG\UserControlBundle\Models\map\User_ListTableMap());
      }
    }
