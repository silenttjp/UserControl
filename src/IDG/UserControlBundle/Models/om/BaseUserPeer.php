...
use IDG\UserControlBundle\Models\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'IDG\\UserControlBundle\\Models\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'IDG\\UserControlBundle\\Models\\map\\UserTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::FIRST_NAME, UserPeer::LAST_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::FIRST_NAME => 1, UserPeer::LAST_NAME => 2, ),
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \IDG\UserControlBundle\Models\map\UserTableMap());
      }
    }
